...
export default function Trisemus({ navigation }) {
    ...
    function EncodeTextFunc() {
        ...
        let arrayUncodedText = textCode.split('')

        console.log(arrayUncodedText)
        // setCodedTextEnd(arrayUncodedText)
    ...
    return (
        <SafeAreaView>
            ...
            <View  style={styles.header}>
                ...
                <Text style={styles.sectionName}>Trisemus Method</Text>
            ...
            <View style={{
                ...
                <Text style={{
                    ...
                    marginBottom: 6,
                    fontSize: 14
                }}>Number of rows in the cipher table:</Text>
